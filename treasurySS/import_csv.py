...
SEGMENT_GP_KEY = {
    ...
    IMPORT_CSV_FIELDLIST_KEY: {
        SegmentGrandParent.segment_grand_parent_long_name.field.name: "Segment Grand Parent Long Name",  # noqa: E501
        SegmentGrandParent.segment_department_code.field.name: "Segment Department Code",  # noqa: E501
        SegmentGrandParent.segment_department_long_name.field.name: "Segment Department Long Name",  # noqa: E501
    },
}
...
SEGMENT_P_KEY = {
    ...
    IMPORT_CSV_FIELDLIST_KEY: {
        SegmentParent.segment_parent_long_name.field.name: "Segment Parent Long Name",  # noqa: E501
...
SEGMENT_KEY = {
    ...
    IMPORT_CSV_FIELDLIST_KEY: {
        Segment.segment_long_name.field.name: "Segment Long Name",
...
ESTIMATE_ROW_KEY = {
    ...
    IMPORT_CSV_FIELDLIST_KEY: {
        EstimateRow.estimate_row_long_name.field.name: "Estimates Row Long Name"
    },
}
...
SUB_SEGMENT_KEY = {
    ...
    IMPORT_CSV_FIELDLIST_KEY: {
        ...
        SubSegment.accounting_authority_code.field.name: "Accounting Authority Code",
        SubSegment.accounting_authority_DetailCode.field.name: "Accounting Authority Detail Code",  # noqa: E501
    },
}
