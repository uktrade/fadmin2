...
class ArchiveExpenditureCategoryTest(TestCase, RequestFactoryBase):
    def setUp(self):
        ...
        self.ExpenditureCategory_grouping_description = "grouping description"
        self.ExpenditureCategory_description = "Longer description"
        ExpenditureCategoryFactory(
            grouping_description=self.ExpenditureCategory_grouping_description,
            description=self.ExpenditureCategory_description,
        )
        current_year = get_current_financial_year()
        self.archive_year = current_year - 1
