# Generated by Django 2.2.13 on 2020-08-28 12:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='chartofaccountDIT.ArchivedExpenditureCategory', verbose_name='Budget Category'),
        ),
        migrations.AddField(
            model_name='simplehistoryarchivednaturalcode',
            name='expenditure_category',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='chartofaccountDIT.ArchivedExpenditureCategory', verbose_name='Budget Category'),
        ),
        migrations.RunSQL('update "chartofaccountDIT_archivednaturalcode" SET expenditure_category_id = a.id '
        ...
        migrations.AddField(
            model_name='simplehistoryarchivedexpenditurecategory',
            name='NAC_category',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='chartofaccountDIT.NACCategory', verbose_name='Budget Grouping'),
        ),
